      ...
      <main className="relative px-6 pt-32">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-24 mb-20 text-center">
            ...
            <button onClick={() => router.push("/submit-report")} className="group relative inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-sky-500 px-8 text-sm font-medium text-white transition-all hover:bg-sky-400">
